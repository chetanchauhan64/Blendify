 ...
 * Avatar click → opens Testimonial Detail Modal
 */
      ...
      {review && (
        ...
        >
          ...
          >
            ...
            <div className={styles.modalReviewer}>
              <div className={styles.modalAvatar}>
                {review.name[0]}
              </div>
              <div className={styles.modalReviewerInfo}>
                <span className={styles.modalReviewerName}>{review.name}</span>
                <span className={styles.modalReviewerRole}>
                  {review.role} · {review.location}
                </span>
              </div>
            </div>

            <p className={styles.modalVerified}>✓ Verified Blendify Customer</p>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
                ...
                >
                  ...
                  <div className={styles.reviewer}>
                    ...
                    <button
                      ...
                      onClick={() => setActiveReview(REVIEWS[current])}
                      title={`View ${REVIEWS[current].name}'s full review`}
                      aria-label={`Open ${REVIEWS[current].name}'s review`}
                    >
